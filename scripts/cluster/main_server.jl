...
polar_order   = zeros(length(Ts),length(As),length(rhos),length(times_log))
nematic_order = zeros(length(Ts),length(As),length(rhos),length(times_log))
C   = zeros(length(Ts),length(As),length(rhos),Int(L/2),length(times_log))
xi  = zeros(length(Ts),length(As),length(rhos),length(times_log))
n   = zeros(length(Ts),length(As),length(rhos),length(times_log))
thetas_save = zeros(Float16,length(Ts),length(As),length(rhos),length(times_log),L,L)
